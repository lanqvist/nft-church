...
const cards: CardProps[] = [
    ...
    },
    {
        date: '16.10.2025',
        title: '',
        description: 'Внутренняя часть Храма расчищена. И в ближайшее время начнётся внутренняя отделка и роспись.',
        imageUrl: CARD_IMAGES[11],
    },
    {
        date: '16.10.2025',
        title: '',
    ...
    },
    {
        date: '16.10.2025',
        title: '',
        description: 'Произведена внешняя отделка верхней околокупольной части Храма.',
        imageUrl: CARD_IMAGES[13],
    },
    {
        date: '16.10.2025',
        title: '',
        description: 'Главный колокол установлен в звонницу Храма.',
        imageUrl: CARD_IMAGES[15],
    },
    {
        date: '16.10.2025',
        title: '',
        description: '',
        imageUrl: CARD_IMAGES[14],
    },
    {
        date: '16.10.2025',
        title: '',
        description: '',
        imageUrl: CARD_IMAGES[16],
    },
];
