...
const cards: CardProps[] = [
    ...
    },
    {
        title: 'Иконостас',
        content:
            'В храме будет расположен 5-ярусный иконостас со следующими рядами: пророческий, праотеческий, деисус, праздничный, местный.',
        imageUrl: cardImg3,
        invertedTitle: true,
    },
    {
    ...
    },
    {
        title: 'Колокола',
        content:
            'В Храме установили 10 колоколов, самый большой из которых весит почти 6 тонн. Колокол отлит в городе Каменск-Уральский Свердловской области и носит имя апостола Варнавы. Колокола Храма изготовлены в городе Каменск-Уральский Свердловской области на предприятии «Пятков и Ко».',
        imageUrl: cardImg5,
    },
    {
        title: 'Убранство',
