...
const factObjects: FactObject[] = createFactObjectFactoryBuilder((builder) => {
    ...
    builder
        ...
        .addFact(
            'Образ выполнен в канонической традиции православной иконописи и является плодо́м труда иконописца, обучавшейся в Свято-Троицкой Сергиевой Лавре — духовном центре, тесно связанном с жизнью и подвигом самого Сергия Радонежского. ',
            { top: '10%', left: '65%' }
        )
        .addFact(
