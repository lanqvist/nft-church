...
const cards: Omit<CardProps, 'className'>[] = [
    ...
    },
    {
        title: '',
        description:
            'NFT-сертификаты передаются благотворителям с использованием технологии блокчейнМы ценим вклад всех благотворителей, и будем рады отблагодарить каждого. После пожертвования вместе с цифровым сертификатом вы сможете выбрать один или несколько подарков, который подготовлен для вас: благодарственная молитва, памятная гравировка и другие.',
